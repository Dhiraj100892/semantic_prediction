...
def get_args():
    ...
    parser.add_argument('--train-data-file-path', type=str, default='../data/train_data_normal.txt',
                        help='path to train file txt')
    parser.add_argument('--val-data-file-path', type=str, default='../data/val_data_normal.txt',
                        help='path to val file txt')
    parser.add_argument('--test-data-file-path', type=str, default='../data/val_data_normal.txt',
    ...
    parser.add_argument('--use-normal', action='store_true', default=False,
                        help='whether to use surface normal or not')
    parser.add_argument('--use-depth', action='store_true', default=False,
                        help='whether to use depth or not')
